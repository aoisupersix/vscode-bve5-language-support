...
export function activate(context: vscode.ExtensionContext) {
    ...
    if(editor !== undefined && editor.document.languageId === LANG_ID_MAP) {
        ...
        const controller = new MapController(distChecker, listFileLoader)
    ...
    context.subscriptions.push(vscode.languages.registerCompletionItemProvider(BVE_MAP_MODE, new MapCompletionItemProvider(structureKeys), '.', '\''))
